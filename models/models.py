...
class Cnn14_SIMCLR_8k(nn.Module):
    def __init__(
        self, sample_rate, window_size, hop_size, mel_bins, fmin, fmax, classes_num
    ):
        super(Cnn14_SIMCLR_8k, self).__init__()
        ...
        self.conv_block4 = ConvBlock(in_channels=256, out_channels=512)
        self.conv_block5 = ConvBlock(in_channels=512, out_channels=1024)
        self.conv_block6 = ConvBlock(in_channels=1024, out_channels=classes_num)

        self.fc1 = nn.Linear(classes_num, classes_num, bias=True)
        self.fc2 = nn.Linear(classes_num, classes_num, bias=True)
        self.fc3 = nn.Linear(classes_num, classes_num, bias=True)
    ...
    def forward(self, input):
        ...
        output_dict = {"clipwise_output": x, "embedding": embedding}
