...
def _load_metrics0(
    ...
    bal_map = np.array(
        [statistics["average_precision"] for statistics in statistics_dict["bal"]]
    )  # (N, classes_num)
    bal_map = np.mean(bal_map, axis=-1)
    test_map = np.array(
        [statistics["average_precision"] for statistics in statistics_dict["test"]]
    )  # (N, classes_num)
    test_map = np.mean(test_map, axis=-1)
    legend = "{}, {}, bal={}, aug={}, bs={}".format(
        data_type, model_type, balanced, augmentation, batch_size
    )
...
def plot(args):
    ...
    class_labels_indices_path = os.path.join(
        dataset_dir, "metadata", "class_labels_indices.csv"
    )
    ...
    if select == "1_cnn13":
        (bal_map, test_map, legend) = _load_metrics(
            "main",
            32000,
            1024,
            320,
        ...
        (line,) = ax.plot(
            test_map, label="cnn13_no_specaug", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(
            test_map, label="Cnn13_no_dropout", color="g", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(
            test_map, label="Cnn13_mixup_in_wave", color="c", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn13_gmpgapgwrp", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn13_gmpgapatt", color="g", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn13_DecisionLevelMax", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn13_DecisionLevelAvg", color="g", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="k", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn13_DecisionLevelAtt", color="k", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn13_Transformer1", color="g", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn13_Transformer3", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="k", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn13_Transformer6", color="k", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="r", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,balanced,mixup", color="r", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,none,none", color="g", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,balanced,none", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(
            test_map,
            label="cnn14,balanced,mixup_from_0_epoch",
            color="m",
            alpha=test_alpha,
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14_time_domain", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,partial_0.9", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="g", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,partial_0.8", color="g", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="k", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,partial_0.7", color="k", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="m", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,partial_0.5", color="m", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14_alternate", color="b", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn1d_ResNet34", color="grey", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="b", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="Cnn13_SpAndWav", color="orange", alpha=test_alpha
        )
        lines.append(line)
        ...
        (line,) = ax.plot(bal_map, color="c", alpha=bal_alpha)
        (line,) = ax.plot(
            test_map, label="cnn14,none,none", color="c", alpha=test_alpha
        )
        lines.append(line)
...
def plot_for_paper(args):
    ...
    if select == "2_all":
        ...
        (line,) = ax.plot(
            test_map, label="CNN14", color="r", alpha=test_alpha, linewidth=linewidth
        )
        lines.append(line)
        ...
        (line,) = ax.plot(
            test_map,
            label="CNN14,bal,mixup-wav (1.9m)",
            color="y",
            alpha=test_alpha,
            linewidth=linewidth,
        )
        ...
        (line,) = ax.plot(
            test_map,
            label="CNN14,no-bal,no-mixup (1.9m)",
            color="b",
            alpha=test_alpha,
            linewidth=linewidth,
        )
...
def plot_for_paper2(args):
    ...
    if True:
        ...
        (line,) = ax[0, 0].plot(
            bal_map, color="r", alpha=bal_alpha, linewidth=linewidth
        )
        (line,) = ax[0, 0].plot(
            test_map, label="CNN14", color="r", alpha=test_alpha, linewidth=linewidth
        )
        ...
        (line,) = ax[0, 0].plot(
            bal_map, color="b", alpha=bal_alpha, linewidth=linewidth
        )
        (line,) = ax[0, 0].plot(
            test_map,
            label="MobileNetV1",
        ...
        (line,) = ax[0, 0].plot(
            bal_map, color="g", alpha=bal_alpha, linewidth=linewidth
        )
        (line,) = ax[0, 0].plot(
            test_map,
            label="Wavegram-Logmel-CNN",
    ...
    if True:
        ...
        (line,) = ax[0, 1].plot(
            bal_map, color="y", alpha=bal_alpha, linewidth=linewidth
        )
        (line,) = ax[0, 1].plot(
            test_map,
            label="CNN14,bal,mixup-wav (1.9m)",
        ...
        (line,) = ax[0, 1].plot(
            bal_map, color="k", alpha=bal_alpha, linewidth=linewidth
        )
        (line,) = ax[0, 1].plot(
            test_map,
            label="CNN14,bal,no-mixup (20k)",
        ...
        (line,) = ax[0, 1].plot(
            bal_map, color="m", alpha=bal_alpha, linewidth=linewidth
        )
        (line,) = ax[0, 1].plot(
            test_map,
            label="CNN14,bal,mixup (20k)",
...
def plot_class_iteration(args):
    ...
    for col in range(0, 3):
        ...
        for _ix in ranges[col]:
            _label = crop_label(config.labels[sorted_indexes[_ix]]) + " ({})".format(
                add_comma(config.full_samples_per_class[sorted_indexes[_ix]])
            )
            (line,) = axs[col].plot(mAP_mat[:, sorted_indexes[_ix]], label=_label)
            lines.append(line)
        box = axs[col].get_position()
        axs[col].set_position([box.x0, box.y0, box.width * 1.0, box.height])
        axs[col].legend(handles=lines, bbox_to_anchor=(1.0, 1.0))
...
def summary_stats(args):
    ...
    bal_train_metrics = get_avg_stats(
        old_workspace,
        bgn_iter=10000,
        fin_iter=50001,
        interval_iter=5000,
    ...
    def _load_metrics(
        ...
        _dict = {
            "bal_train": {
                "average_precision": statistics_dict["bal"][_idx]["average_precision"],
                "auc": statistics_dict["bal"][_idx]["auc"],
            },
            "eval": {
                "average_precision": statistics_dict["test"][_idx]["average_precision"],
    ...
    iteration = 600000
    output_dict["cnn13_system_iteration60k"] = _load_metrics(
        "main",
        32000,
        1024,
        320,
    ...
    iteration = 560000
    output_dict["mobilenetv1_system_iteration56k"] = _load_metrics(
        "main",
        32000,
        1024,
        320,
...
def prepare_plot_long_4_rows(sorted_lbs):
    ...
    f, (ax1a, ax2a, ax3a, ax4a) = plt.subplots(
        4, 1, sharey=False, facecolor="w", figsize=(10, 12)
    )
    ...
    ax2a.xaxis.set_ticklabels(
        truncated_sorted_lbs[K : 2 * K], rotation=90, fontsize=fontsize
    )
    ...
    ax3a.xaxis.set_ticklabels(
        truncated_sorted_lbs[2 * K : 3 * K], rotation=90, fontsize=fontsize
    )
    ...
    ax4a.xaxis.set_ticklabels(
        truncated_sorted_lbs[3 * K :], rotation=90, fontsize=fontsize
    )
...
def _scatter_4_rows(x, ax, ax2, ax3, ax4, s, c, marker=".", alpha=1.0):
    N = len(x)
...
def plot_long_fig(args):
    ...
    audio_clips_per_class = (
        stats["official_balanced_trainig_samples"]
        + stats["official_unbalanced_training_samples"]
    )
    audio_clips_per_class = audio_clips_per_class[sorted_indexes]

    (ax1a, ax2a, ax3a, ax4a, ax1b, ax2b, ax3b, ax4b) = prepare_plot_long_4_rows(
        sorted_labels
    )
    ...
    maps_mobilenetv1 = stats["mobilenetv1_system_iteration56k"]["eval"][
        "average_precision"
    ]
    maps_mobilenetv1 = maps_mobilenetv1[sorted_indexes]

    maps_logmel_wavegram_cnn = _load_metrics0_classwise(
        "main",
        32000,
        1024,
        320,
    ...
    line3te = _plot_4_rows(
        maps_logmel_wavegram_cnn,
        ax1b,
        ax2b,
        ax3b,
        ax4b,
    ...
    ax1b.scatter(
        np.arange(N)[sorted_rate != None],
        sorted_rate[sorted_rate != None],
        s=12,
        c="r",
        linewidth=0.8,
        marker="+",
    ...
    line_label_quality = ax4b.scatter(
        np.arange(N)[sorted_rate != None],
        sorted_rate[sorted_rate != None],
        s=12,
        c="r",
    ...
    ax1b.scatter(
        np.arange(N)[sorted_rate == None],
        0.5 * np.ones(len(np.arange(N)[sorted_rate == None])),
        s=12,
        c="r",
        linewidth=0.8,
        marker="_",
    ...
    plt.legend(
        handles=[line0te, line1te, line2te, line3te, line_label_quality],
        fontsize=6,
        loc=1,
    )
...
def spearman(args):
    ...
    training_samples = np.array(stats["official_balanced_trainig_samples"]) + np.array(
        stats["official_unbalanced_training_samples"]
    )
...
def print_results(args):
    (mAP, mAUC, dprime) = _load_metrics_classwise(
        "main",
        32000,
        1024,
        320,
    ...
    #
    (mAP, mAUC, dprime) = _load_metrics0_classwise2(
        "main",
        32000,
        1024,
        320,
