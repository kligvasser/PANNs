...
def plot_classwise_iteration_map(args):
    ...
    statistics_dict = pickle.load(
        open(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_WavegramLogmelCnn_balanced_mixup_bs32.pkl",
            "rb",
        )
    )
...
def plot_six_figures(args):
    ...
    if True:
        ...
        # Wavegram-Logmel-CNN
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_WavegramLogmelCnn_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[0, 0].plot(
        ...
        # Cnn14
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[0, 0].plot(
        ...
        # MobileNetV1
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_MobileNetV1_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[0, 0].plot(
    ...
    if True:
        ...
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_balanced_mixup_timedomain_bs32.pkl"
        )
        (line,) = ax[0, 1].plot(
        ...
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_balanced_nomixup_bs32.pkl"
        )
        (line,) = ax[0, 1].plot(
            bal_map, color="g", alpha=bal_alpha, linewidth=linewidth
        )
        ...
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_nobalanced_nomixup_bs32.pkl"
        )
        (line,) = ax[0, 1].plot(
            bal_map, color="b", alpha=bal_alpha, linewidth=linewidth
        )
        ...
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[0, 1].plot(
        ...
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_balanced_train_Cnn14_balanced_nomixup_bs32.pkl"
        )
        (line,) = ax[0, 1].plot(
    ...
    if True:
        ...
        # Embedding size 128
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_emb128_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[0, 2].plot(
            bal_map, color="g", alpha=bal_alpha, linewidth=linewidth
        )
        ...
        # Embedding size 32
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_emb32_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[0, 2].plot(
            bal_map, color="b", alpha=bal_alpha, linewidth=linewidth
        )
    ...
    if True:
        ...
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_0.8full_train_Cnn14_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[1, 0].plot(
            bal_map, color="b", alpha=bal_alpha, linewidth=linewidth
        )
        ...
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_0.5full_train_Cnn14_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[1, 0].plot(
            bal_map, color="g", alpha=bal_alpha, linewidth=linewidth
        )
    ...
    if True:
        ...
        # Cnn14 + 16 kHz
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_16k_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[1, 1].plot(
            bal_map, color="b", alpha=bal_alpha, linewidth=linewidth
        )
        ...
        # Cnn14 + 8 kHz
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel64_fmin50_fmax14000_full_train_Cnn14_8k_balanced_mixup_bs32.pkl"
        )
        (line,) = ax[1, 1].plot(
            bal_map, color="g", alpha=bal_alpha, linewidth=linewidth
        )
    ...
    if True:
        ...
        # Cnn14 + 128 mel bins
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel128_fmin50_fmax14000_full_train_Cnn14_balanced_mixup_bs32.pkl"
        )
        ...
        # Cnn14 + 32 mel bins
        (bal_map, test_map) = load_statistics(
            "paper_statistics/statistics_sr32000_window1024_hop320_mel32_fmin50_fmax14000_full_train_Cnn14_balanced_mixup_bs32.pkl"
        )
...
def plot_long_fig(args):
    ...
    audio_clips_per_class = (
        stats["official_balanced_training_samples"]
    ...
    maps_panns_wavegram_logmel_cnn14 = stats["panns_wavegram_logmel_cnn14"]["eval"][
        "average_precision"
    ]
    ...
    # Plot mAPs
    _scatter_4_rows(
        maps_panns_wavegram_logmel_cnn14, ax1b, ax2b, ax3b, ax4b, s=5, c="g"
    )
    ...
    line0te = _plot_4_rows(
        maps_panns_wavegram_logmel_cnn14,
        ax1b,
        ax2b,
        ax3b,
        ax4b,
    ...
    ax1b.scatter(
        np.arange(N)[sorted_label_quality != None],
        sorted_label_quality[sorted_label_quality != None],
        s=12,
        c="r",
        linewidth=0.8,
        marker="+",
    ...
    ax1b.scatter(
        np.arange(N)[sorted_label_quality == None],
        0.5 * np.ones(len(np.arange(N)[sorted_label_quality == None])),
        s=12,
        c="r",
        linewidth=0.8,
        marker="_",
...
def prepare_plot_long_4_rows(sorted_lbs):
    ...
    f, (ax1a, ax2a, ax3a, ax4a) = plt.subplots(
        4, 1, sharey=False, facecolor="w", figsize=(10, 10.5)
    )
...
if __name__ == "__main__":
    ...
    parser_classwise_iteration_map = subparsers.add_parser(
        "plot_classwise_iteration_map"
    )
